...
2️⃣ Select a target job role
3️⃣ System extracts text using PyPDF2
4️⃣ Skills, education & experience are detected
5️⃣ Resume is compared with role dataset
6️⃣ TF-IDF calculates similarity score
7️⃣ Final score + suggestions are generated
